...
<style scoped>
.sched-panel { background: var(--bg-card); border: 1px solid var(--border-input); border-radius: 8px; padding: 16px; margin: 12px 0; }
.sched-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; }
.sched-header h3 { margin: 0; color: var(--text-primary); }
.sched-close { background: none; border: none; color: var(--text-muted); cursor: pointer; font-size: 18px; }
.sched-add-form { background: var(--bg-hover); border-radius: 6px; padding: 12px; margin-bottom: 12px; }
.sched-prompt-input { width: 100%; padding: 8px; background: var(--bg-input); border: 1px solid var(--border-input); border-radius: 4px; color: var(--text-primary); box-sizing: border-box; margin-bottom: 8px; }
.sched-options { display: flex; gap: 8px; align-items: center; margin-bottom: 8px; flex-wrap: wrap; }
.sched-cron-input { flex: 1; padding: 6px; background: var(--bg-input); border: 1px solid var(--border-input); border-radius: 4px; color: var(--text-primary); min-width: 200px; }
.sched-priority-select { padding: 6px; background: var(--bg-input); border: 1px solid var(--border-input); border-radius: 4px; color: var(--text-primary); }
.sched-oneshot-label { color: var(--text-secondary); font-size: 13px; display: flex; align-items: center; gap: 4px; }
...
.sched-empty { color: var(--text-tertiary); font-style: italic; padding: 12px; text-align: center; }
.sched-item { background: var(--bg-hover); border-radius: 6px; padding: 10px; margin-bottom: 6px; }
...
.sched-item-prompt { color: var(--text-primary); font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex: 1; }
...
.sched-p-low { background: #66666633; color: var(--text-muted); }
.sched-item-meta { display: flex; gap: 8px; font-size: 12px; color: var(--text-muted); flex-wrap: wrap; margin-bottom: 6px; }
...
.sched-actions button { padding: 4px 10px; border: 1px solid var(--border-input); border-radius: 3px; background: var(--bg-input); color: var(--btn-text); cursor: pointer; font-size: 12px; }
.sched-actions button:hover { background: var(--border-subtle); }
.sched-queue-section { border-top: 1px solid var(--border-subtle); padding-top: 12px; }
.sched-queue-section h4 { margin: 0 0 8px; color: var(--text-primary); }
.sched-queue-item { display: flex; gap: 8px; align-items: center; padding: 6px 8px; background: var(--bg-hover); border-radius: 4px; margin-bottom: 4px; }
...
.sched-q-prompt { flex: 1; color: var(--btn-text); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 13px; }
